...
class UpToSem4 extends StatefulWidget {
  @override
  _UpToSem4State createState() => _UpToSem4State();
}

class _UpToSem4State extends State<UpToSem4> {
  double spi1=8.0;
  double spi2 = 7.5;
  double spi3 = 7.0;
  double spi4 = 8.5;
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              double total=spi1+spi2+spi3+spi4;
