...
class UpToSem7 extends StatefulWidget {
  @override
  _UpToSem7State createState() => _UpToSem7State();
}

class _UpToSem7State extends State<UpToSem7> {
  double spi1=8.0;
  double spi2 = 7.5;
  double spi3 = 7.0;
  double spi4 = 8.5;
          ...
          child:SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: () {
                    double total=spi1+spi2+spi3+spi4+spi5+spi6+spi7;
