...
class _Sem6State extends State<Sem6> {
  ...
  String course1='HS304 Environmental Science';
  String course2="CS312 Software Engineering";
  String course3='CS313 Elective 1';
  String course4='CS314 Elective 2';
  String course5='HS303 Open Elective';
  String course6='CS315 Lab Based Project-3';
  int grade1=10; int grade2=8; int grade3=9; int grade4=6; int grade5=7; int grade6=9;
  int o1=10*4; int o2=8*4; int o3=9*4; int o4=6*4; int o5=7*4; int o6=9*2;
  ...
  void courses(branchType selectBranch) {
    ...
    {
      course1='HS304 Environmental Science';
      course2="CS312 Software Engineering";
      course3='CS313 Elective 1';
      course4='CS314 Elective 2';
      course5='HS303 Open Elective';
      course6='CS315 Lab Based Project-3';
    }
    if(selectBranch==branchType.ece)
    {
      course1='HS304 Environmental Science';
      course2="EC312 Linear Integrated Circuit Design";
      course3='EC313 Elective 1';
      course4='EC314 Elective 2';
      course5='HS303 Open Elective';
      course6='EC315 DSP + Microwave';
    }
    ...
    if(selectBranch==branchType.me)
    {
      course1='HS304 Environmental Science';
      course2="ME312 HMT";
      course3='ME313 Elective 1';
      course4='ME314 Elective 2';
      course5='HS303 Open Elective';
      course6='ME315 Adv. Manufacturing + NCCNC';
    }
  }
...
//
              ...
              GestureDetector(
                onTap: () {
                  o1=grade1*4; o2=grade2*4; o3=grade3*4; o4=grade4*4; o5=grade5*4; o6=grade6*2;
                  if(grade1==11)
                    o1=10*4;
                  if(grade2==11)
                    o2=10*4;
                  ...
                  if(grade6==11)
                    o6=10*2;
                  SPIBrain2 calc = SPIBrain2(4, 4, 4, 4, 4, 2,o1,o2,o3,o4,o5,o6);
                  Navigator.push(
                    context,
