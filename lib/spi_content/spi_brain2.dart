...
SPIBrain2(this.c1, this.c2, this.c3, this.c4, this.c5, this.c6,this.course1, this.course2, this.course3, this.course4, this.course5, this.course6);
  ...
  final int course6;
  int div;
  final c1,c2,c3,c4,c5,c6;
  double _finalSPI;
  String calculateSPI() {
    div=c1+c2+c3+c4+c5+c6;
    ...
    course6==0?div=div-c6:div=div;
    if(div==0)
      div=1;
    _finalSPI=(course1+course2+course3+course4+course5+course6)/div;
